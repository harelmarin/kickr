 ...
 * <p>
 * Cette classe fournit des méthodes statiques pour convertir des dates/horaires
 * au format
...
public class DateTimeConverter {
    ...
    /**
     * Convertit une date/heure UTC en heure locale de France (Europe/Paris) et
     ...
     * @return la date/heure convertie en fuseau horaire Europe/Paris, au format
     *         "yyyy-MM-dd'T'HH:mm:ss"
     * @throws java.time.format.DateTimeParseException si la chaîne UTC n'est pas au
