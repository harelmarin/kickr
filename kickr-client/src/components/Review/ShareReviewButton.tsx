...
export const ShareReviewButton = ({ review, variant = 'icon' }: ShareReviewButtonProps) => {
        ...
        <>
            ...
            <div className="flex items-center gap-2">
                <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-xl transition-all duration-300 group overflow-hidden ${variant === 'full'
                        ? 'bg-[#4466ff] text-white font-black uppercase text-xs hover:brightness-110 active:scale-95'
                        : 'bg-white/5 text-[#445566] hover:text-[#4466ff] hover:bg-white/10 text-[10px] font-bold uppercase tracking-widest'
                        }`}
                ...
                >
                    {isGenerating ? (
                        ...
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="w-4 h-4 group-hover:translate-y-[-1px] transition-transform">
                ...
                <button
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-lg bg-white/5 text-[#445566] hover:text-[#1DA1F2] hover:bg-[#1DA1F2]/10 transition-all duration-300"
