...
export const LeagueStandings: React.FC<LeagueStandingsProps> = ({ standingsJson, maxEntries = 10 }) => {
    if (!standingsJson) {
        return (
            <div className="py-32 flex flex-col items-center justify-center border border-white/5 bg-white/[0.02] rounded-sm">
                <div className="w-16 h-16 mb-8 text-white/10">
                ...
                <p className="text-white/40 uppercase tracking-[0.3em] text-[10px] font-black mb-2 text-center">Data Protocol Offline</p>
                <p className="text-white/40 text-[11px] font-bold uppercase tracking-widest text-center max-w-sm px-12">
    ...
    if (standings.length === 0) {
        return (
            <div className="py-32 flex flex-col items-center justify-center border border-white/5 bg-white/[0.02] rounded-sm">
                ...
                <p className="text-white/40 uppercase tracking-[0.3em] text-[10px] font-black mb-2 text-center">Empty Ranks</p>
                <p className="text-white/40 text-[11px] font-bold uppercase tracking-widest text-center max-w-sm px-12">
    ...
    // Limit to maxEntries
    const displayedStandings = standings.slice(0, maxEntries);

    return (
        <div className="overflow-x-auto rounded-sm border border-white/5 bg-white/[0.02]">
