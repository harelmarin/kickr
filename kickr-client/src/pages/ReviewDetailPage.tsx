                            ...
                            {currentUser && (
                                <form onSubmit={handleAddComment} className="bg-white/[0.02] border border-white/5 p-8 rounded-sm">
                                    <textarea
                                        ...
                                        className="w-full bg-[#14181c]/40 border border-white/5 rounded-sm p-4 text-[11px] font-bold text-white placeholder-white/20 focus:border-kickr/40 transition-all outline-none resize-none h-24 mb-6"
                                    />
