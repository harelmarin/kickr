          ...
          <div className="mt-12">
            <div className="flex items-end justify-between border-b border-white/5 pb-3 md:pb-4 gap-4">
              ...
              <div className="flex flex-col items-end">
                ...
                <span className="text-[7px] md:text-[8px] uppercase tracking-widest text-muted font-bold mt-1">Clubs Listed</span>
              </div>
            </div>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8">
            <div className="flex items-center justify-between mb-4 md:mb-8 border-b border-white/5 pb-2 md:pb-4">
              <h2 className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.3em] md:tracking-[0.4em] text-muted italic">All Clubs</h2>
            ...
            {allTeams.length < (data?.totalElements || 0) && (
              <div className="mt-20 flex justify-center">
                <button
                  ...
                  disabled={isLoading}
                  className="group relative overflow-hidden px-10 py-4 rounded-sm bg-black/[0.02] border border-white/5 text-[10px] font-black uppercase tracking-[0.3em] text-secondary hover:text-main hover:border-black/20 transition-all active:scale-95"
                >
