        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-16">
                  ...
                  <div className="flex items-center gap-6 md:gap-12">
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <select
                        ...
                        className="bg-transparent text-[10px] md:text-[11px] font-bold text-[#8899aa] focus:text-main outline-none cursor-pointer border-none p-0 m-0"
                      >
          ...
          <div className="space-y-6 md:space-y-8">
            <section className="bg-black/[0.02] border border-white/5 rounded-sm p-4 md:p-8">
              ...
              <div className="mb-8">
                <div className="flex justify-between text-[7px] md:text-[9px] font-black uppercase tracking-widest text-main/40 mb-2 md:mb-3 italic">
                  <span>Battle Records</span>
                  <span className="text-main/60">{stats.wins}W <span className="text-main/10 mx-0.5 md:mx-1">/</span> {stats.draws}D <span className="text-main/10 mx-0.5 md:mx-1">/</span> {stats.losses}L</span>
                </div>
              ...
              <div className="mb-8">
                <h4 className="text-[7px] md:text-[9px] font-black text-main/40 uppercase tracking-widest mb-3 md:mb-4 italic">Operational Form</h4>
                  ...
                  {stats.form.map((res, i) => (
                    <div
                      ...
                      className={`w-5 h-5 md:w-6 md:h-6 rounded-sm flex items-center justify-center text-[8px] md:text-[9px] font-black ${res === 'W' ? 'bg-kickr text-black shadow-[0_0_8px_rgba(var(--kickr-rgb),0.2)]' :
                        res === 'D' ? 'bg-black/10 text-main/60' :
              ...
              <div className="pt-4 md:pt-6 border-t border-white/5 space-y-3 md:space-y-4">
                <div className="flex items-center justify-between uppercase tracking-widest">
                  <span className="text-[7px] md:text-[8px] font-black text-main/20">Clean Sheets</span>
                  <span className="text-lg md:text-xl font-black text-main italic leading-none">{stats.cleanSheets}</span>
                </div>
                <p className="text-[7px] md:text-[10px] text-main/10 italic leading-relaxed uppercase tracking-tighter">
