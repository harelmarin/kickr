        ...
        <main className="min-h-screen bg-[#0a0b0d] pt-32 pb-20">
            <div className="max-w-3xl mx-auto px-6">
                <header className="mb-16">
                    ...
                    <p className="text-white/40 text-xs uppercase tracking-[0.2em] font-bold">Terms & Infrastructure Intel • Last Modified Jan 2026</p>
                </header>
                    ...
                    <section className="bg-white/[0.02] border border-white/5 p-8 rounded-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                <h3 className="text-[10px] font-black text-white uppercase tracking-widest">Platform Editor</h3>
                                <ul className="list-none text-white/60 text-sm space-y-1">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-[10px] font-black text-white uppercase tracking-widest">Data Hosting</h3>
                ...
                <footer className="mt-20 pt-8 border-t border-white/5 text-center">
                    <span className="text-white/40 text-[9px] font-black uppercase tracking-[0.4em]">Kickr Tactical Intelligence System v1.0</span>
                </footer>
            </div>
        </main>
    );
