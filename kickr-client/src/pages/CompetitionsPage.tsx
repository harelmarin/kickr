        ...
        <header className="mb-16">
          ...
          <div className="mt-12 flex flex-col md:flex-row items-center justify-between border-y border-white/5 py-6 gap-6">
            ...
            <div className="flex flex-col items-end">
              ...
              <span className="text-[9px] uppercase tracking-widest text-[#445566] font-bold">Leagues Active</span>
            </div>
          </div>
        </header>
                  ...
                  <Link to={`/competitions/${comp.id}`} className="group block">
                    <div className="aspect-square bg-[#14181c] rounded-2xl border border-white/5 p-8 flex items-center justify-center mb-4 transition-all duration-500 group-hover:border-kickr/40 group-hover:bg-[#1b2228] relative overflow-hidden">
                      <img
                        src={comp.logoUrl}
                        alt={comp.name}
                        className="max-w-[70%] max-h-[70%] object-contain transition-transform duration-500 group-hover:scale-110 relative z-10"
                      />
                    </div>
                    <h3 className="text-center text-[10px] font-black text-[#667788] group-hover:text-white transition-colors tracking-widest uppercase px-2 truncate">
                      {comp.name}
                    </h3>
                  </Link>
                </motion.div>
